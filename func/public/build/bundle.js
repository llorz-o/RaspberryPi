...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[4](/*index*/ ctx[1]);
    	}
    ...
    function create_fragment(ctx) {
    	...
    	let each_value = /*functions*/ ctx[2];
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*functions, changeSite*/ 12) {
    				each_value = /*functions*/ ctx[2];
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (dirty & /*iframeUrl*/ 1 && !src_url_equal(iframe.src, iframe_src_value = /*iframeUrl*/ ctx[0])) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('iframeUrl' in $$props) $$invalidate(0, iframeUrl = $$props.iframeUrl);
    	};
    	...
    	return [iframeUrl, index, functions, changeSite, click_handler];
    }
